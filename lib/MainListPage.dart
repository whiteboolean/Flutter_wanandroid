...
class MainListPage extends GetView<MainTabController> {
  final String title;
  ...
  Widget listView() {
    ...
    return ListView.builder(
      ...
      itemCount: 1 + controller.listItems.length + 1,
      // 轮播 + 列表 + loading
      ...
      itemBuilder: (context, index) {
        ...
        if (index == 0) {
        ...
        } else if (index < 1 + controller.listItems.length) {
          ...
          final article = controller.listItems[articleIndex];
    ...
    child: Stack(
      ...
      children: [
        CarouselSlider(
          ...
          items:
              controller.bannerImages.map((bannerData) {
                return Builder(
