              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 8.0), // 时间和图标之间留点空隙
                    Icon(
                      true?Icons.favorite : Icons.favorite_border, // 根据是否点赞选择图标
                      size: 18.0,
                      color: true ? Colors.red : Colors.grey[600], // 点赞和未点赞的颜色
                    ),
